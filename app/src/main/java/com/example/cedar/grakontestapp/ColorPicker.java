...
public class ColorPicker extends View {
    ...
    // Measures the size of the screen so that it draws the right size color wheel
    @Override
    ...
    //Fills in the color wheel with all possible color gradients
    private Bitmap createColorWheelBitmap(int width, int height) {
    	...
    	/*
	* This function handles the touches to the color wheel and saves the resulting color in a variable
	*/
    ...
    // Allows the color to be set from an outside class
    public void setColor(int color) {
        Color.colorToHSV(color, colorHSV);
    }

    //Returns the master color to the calling function
    public int getColor() {
